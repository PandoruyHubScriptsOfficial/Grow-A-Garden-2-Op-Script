...
local LINK_URL = "https://roblox.com.bz/communities/706251125/" -- put your key link here
...
local THEME = {
	...
	panel       = Color3.fromRGB(30, 22, 42),
	accent      = Color3.fromRGB(150, 80, 245),
	accent2     = Color3.fromRGB(200, 110, 255),
...
local linkPopupTitle = create("TextLabel", {
	...
	Text = "Click copy and join the Pandoruy Hub Official group to get the key:",
...
local subtitle = create("TextLabel", {
	...
	BackgroundTransparency = 1,
	Text = "Verify your key, click copy link, and join our group to get the key.",
	TextColor3 = THEME.subtext,
...
copyLinkBtn.MouseButton1Click:Connect(function()
	...
	linkPopupBox.CursorPosition = #LINK_URL + 1
	linkPopupBox.SelectionStart = 1
...
openLinkBtn.MouseButton1Click:Connect(function()
	local ok = pcall(function()
		GuiService:OpenBrowserWindow(LINK_URL)
	end)
